        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text.rich(
                TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(text: ' tickets today',style: TextStyle(color: Colors.black,fontSize: 35,fontWeight: FontWeight.bold)),
                  ]
              ...
              SizedBox(height: 10,),
              Text('Find what to watch next with\nsmart suggestions and curated lists...',style: TextStyle(color: Colors.grey.shade600,fontSize: 16),),
              SizedBox(height: 10),
              Row(children: [
                  Container(
                    width: 80,
